...
class CRF(nn.Cell):
    ...
    Returns:
        ...
        Evaluation mode: Tuple, the index for each step with the highest score; Tuple, the index for the last step with the highest score.
    '''
    ...
    def _realpath_score(self, features, label):
        ...
        定义_realpath_score方法，计算真实路径的放射和转移分数
        '''
        label = label * 1
    ...
    def _normalization_factor(self, features):
        ...
        定义_normalization_factor()方法，计算所有可能的输出序列的分数
        '''
