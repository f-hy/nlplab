...
class Gram:
    ...
    def preprocessing(self):  # 小写 替换符号 分句
        # symbols = ',.?!:;<>/'
    ...
    def additive_smoothing(self):  # 频数转化为频率  使用加一平滑法
        ...
        if self.is_bio:
            history = {}  # 以w为历史的bio-gram的数量和    bio-gram的N
...
if __name__ == '__main__':
    ...
    gram.auto_cal(False)
    print("PPL of uni-gram:", gram.ppl)  # 866.355014566722
    gram.auto_cal(True)
    print("PPL of bio-gram:", gram.ppl)  # 80.7862557110973
